...
assert.equal(reviewPublisher.metadata.version, "0.9.2");
...
assert.deepEqual(
  ...
  [["github-read", "0.9.2"], ["github-review-publish", "0.9.2"], ["llm-codex-subscription", "0.1.2"]],
);
...
assert.deepEqual(
  ...
  [["conversation-agent", "0.9.2"], ["llm-codex-subscription", "0.1.2"], ["telegram-channel", "0.6.2"]],
);
