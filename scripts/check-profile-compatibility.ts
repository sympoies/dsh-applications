...
assert.equal(reviewPublisher.metadata.version, "0.9.4");
...
assert.deepEqual(
  ...
  [["github-read", "0.9.4"], ["github-review-publish", "0.9.4"], ["llm-codex-subscription", "0.1.4"]],
);
...
assert.deepEqual(
  ...
  [["conversation-agent", "0.9.4"], ["llm-codex-subscription", "0.1.4"], ["telegram-channel", "0.6.3"]],
);
