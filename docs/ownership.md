...
| dsh-applications | Reusable public packages, plugin/profile catalog, public compatibility evidence, portable batch invocation bytes, and application orchestration for one admitted instance | Private deployment validation, runtime invocation adapters, artifact installation, rollout, and cross-generation recovery |
