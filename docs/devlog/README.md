...
A time-ordered narrative of notable work on dsh-applications: what changed,
...
- Pull requests retain detailed review and delivery evidence. The devlog
  summarizes the milestones that remain useful after a pull request merges.

## When to add an entry

Add one after non-trivial development work produces a durable outcome worth
future lookup: a shipped application change, validated milestone,
compatibility or security decision, incident-relevant finding, or external
reference. Skip trivial, transient, and same-turn fixes with no future
...
- Keep current docs current. The devlog records history; it does not own the
  current application contract, architecture, release rules, or runbook.
